...
const polyjuiceAddress = addressTranslator.ethAddressToGodwokenShortAddress("0x7da373Ba58A5b492F3C3282E49467dcdF2bE8f19");
...
export function App() {
    ...
    return (
        <div>
            <div class="card border-primary text-primary mb-3">Your ETH address: <b>{accounts?.[0]}</b></div>
            <div class="card border-primary text-primary mb-3">Your Polyjuice Adress: <b>{ polyjuiceAddress }</b></div>
            <div class="card border-primary text-primary mb-3">Balance: <b>{balance ? (balance / 10n ** 8n).toString() : <LoadingIndicator />} CKB</b></div>
            <div class="card border-primary text-primary mb-3">Deployed contract address: <b>{contract?.address || '-'}</b> <br /></div>
            <p>
